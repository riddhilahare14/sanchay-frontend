...
// 					disabled={closing}
// 					className="w-full mt-6 py-3 rounded-xl bg-gray-900 text-white font-medium disabled:opacity-50"
// 				>
...
// 							एकूण ₹ {preview.totalBankDeposit.toLocaleString("en-IN")} बँकेत जमा झाल्याची नोंद केली जाईल.
// 						</p>
