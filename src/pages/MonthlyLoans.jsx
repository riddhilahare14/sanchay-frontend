...
//     setPrincipalInput(
//       loan.monthlyPaid
//         ? String(loan.monthlyPrincipalRepayment)
//         : ""
//     );
...
//     if (
//       principal >
//       Number(selectedLoan.remainingPrincipal)
//     ) {
//       setError(
//         "मुद्दल परतफेड बाकी कर्जापेक्षा जास्त असू शकत नाही"
//       );
//       return;
//     }
...
//                   updatedLoan.principalRepayment,
//                 monthlyInterest:
//                   updatedLoan.monthlyInterest,
//                 monthlyTotalReceived:
//                   updatedLoan.totalReceived,
//               }
//             : loan
//         )
//       );
...
//   const allLoansPaid =
//     loans.length === 0 ||
//     loans.every((loan) => loan.monthlyPaid);

//   const allContributionsPaid =
//     members.length > 0 &&
//     members.every((member) => member.monthlyPaid);
...
//                 className={
//                   loan.monthlyPaid
//                     ? "bg-green-50 border border-green-200 rounded-2xl p-5 shadow-sm"
...
//                       <button
//                         onClick={() =>
//                           handleMarkPaidClick(loan)
//                         }
//                         className="w-9 h-9 rounded-lg bg-white border border-gray-300 text-gray-600 flex items-center justify-center text-lg"
//                         title="Edit"
//                       >
//                         ✎
//                       </button>
...
//                         handleMarkPaidClick(loan)
//                       }
//                       className="w-full mt-5 py-3 rounded-xl bg-gray-900 text-white font-medium"
//                     >
//                       जमा झाले
//                     </button>
//                   </>
...
//         <div className="fixed inset-0 bg-black/40 flex items-end justify-center px-4 pb-4 z-50">
...
//               className="w-full mt-4 px-4 py-3 rounded-xl border border-gray-300 outline-none focus:ring-2 focus:ring-gray-400"
//               autoFocus
//             />
...
//                 }}
//                 disabled={updating}
//                 className="flex-1 py-3 rounded-xl bg-gray-100 text-gray-700 font-medium disabled:opacity-50"
//               >
//                 रद्द करा
//               </button>
