...
//             {members.filter((member) => member.monthlyPaid).length}
//             {" / "}
//             {members.length}
//           </p>

//           <p className="text-sm text-gray-500 mt-1">
//             सदस्यांची वर्गणी जमा झाली
//           </p>
...
//             disabled={markingAll}
//             className="w-full mb-5 py-3 rounded-xl bg-gray-900 text-white font-medium disabled:opacity-50"
//           >
//             {markingAll
//               ? "जमा करत आहे..."
...
//                   className="bg-green-100 text-green-700 px-4 py-2 rounded-xl text-sm font-medium disabled:opacity-50"
//                 >
//                   {updatingId === member.id ? "..." : "पूर्ववत करा"}
//                 </button>
//               ) : (
//                 <button
//                   onClick={() => handleToggleMonthlyPaid(member.id)}
//                   disabled={updatingId === member.id}
//                   className="bg-gray-900 text-white px-4 py-2 rounded-xl text-sm font-medium disabled:opacity-50"
//                 >
//                   {updatingId === member.id ? "..." : "जमा झाले"}
//                 </button>
//               )}
